 ...
 * AJAX handler to store the state of dismissible notices.
 */
// add_action( 'wp_ajax_dismissed_notice_handler_cssfe', 'notice_handler_cssfe' );
//  function notice_handler_cssfe() {
//     // Pick up the notice "type" - passed via jQuery (the "data-notice" attribute on the notice)
//       $type = $_REQUEST['type'];
// 	// Store it in the options table
// 	$get_installation_time = strtotime("now");
...
add_action( 'wp_ajax_acssfe_maybe_later_will_review', 'acssfe_maybe_later_will_review' );
/**
 * AJAX handler to store the state of dismissible notices.
 */
function acssfe_maybe_later_will_review() {
